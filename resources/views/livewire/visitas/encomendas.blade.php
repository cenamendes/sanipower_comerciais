                                ...
                                @foreach ($detalhesEncomenda as $detalhe)
                                    <tr>
                                        ...
                                        <td><button type="button"
                                                class="btn btn-primary"wire:click="comentarioModal({{ json_encode($detalhe->id) }}, {{ json_encode($detalhe->order) }})"><i
                                            ...
                                            @if ($cmt->count() > 0)
                                                <button type="button" class="btn btn-primary"
                                                    wire:click="verComentario({{ json_encode($detalhe->id) }})"style="margin-top: 0.6rem;">
                                                    Ver Comentário
                                                </button>
                                            @endif
                                        </td>
