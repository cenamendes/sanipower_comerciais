<div>
    ...
    <div class="modal fade" id="modalComentarioProp" tabindex="-1" role="dialog" aria-labelledby="modalComentarioProp" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-outline-primary" wire:click="sendComentario({{ json_encode($propostaID) }})">Adicionar</button>
                </div>
            </div>
        </div>
    </div>

    <div class="modal fade" id="modalVerComentarioProposta" tabindex="-1" role="dialog" aria-labelledby="modalVerComentarioLabel" aria-hidden="true">
